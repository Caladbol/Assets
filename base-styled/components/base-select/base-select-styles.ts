...
export const SelectContainer = styled('div')<StateProps>(
...
export const StyledArrow = styled(TiArrowSortedDown)<{ open: boolean }>(
  ({ theme, open }) => ({
...
export const StyledClear = styled(IoMdClose)(({ theme }) => ({
  cursor: 'pointer',
  color: theme.palette.neutralActions['5'],
  fontSize: '1.5rem'
}))
